const socialLinks = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/vannes.batteries/?locale=fr_FR",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/vannesbatteries/?hl=fr",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "X (Twitter)",
    href: "https://x.com/VANNESBATTERIES",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "Pages Jaunes",
    href: "https://www.pagesjaunes.fr/pros/55563862",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
